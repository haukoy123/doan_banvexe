<%@ Page Title="" Language="C#" MasterPageFile="~/admin/trangchuadmin.Master" AutoEventWireup="true" CodeBehind="QLnhanvien.aspx.cs" Inherits="DoAn.admin.QLnhanvien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="noidung" runat="server">
    <div id="ds_nhanvien" runat="server" style="text-align: center;">
        ...
        <asp:GridView ID="GridView1" PageSize="10" runat="server" AllowPaging="true"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="tennx" HeaderText="Nhà Xe" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
...
<asp:Content ID="content5" ContentPlaceHolderID="gd_them" runat="server">
    ...
    <div id="them" visible="false" runat="server">
        <div class="vien_ttnx_nv" runat="server">
            ...
            <br />
            <asp:TextBox ID="tb_dt_nx" runat="server" CssClass="css_intput inp_nhaxe" OnTextChanged="tb_dt_nx_TextChanged" AutoPostBack="true"></asp:TextBox>
            <br />
            ...
            <br />
            <asp:TextBox ID="tb_email_nx" runat="server" CssClass="css_intput inp_nhaxe" OnTextChanged="tb_email_nx_TextChanged" AutoPostBack="true"></asp:TextBox>
            <br />
