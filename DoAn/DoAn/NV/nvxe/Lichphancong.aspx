<%@ Page Title="" Language="C#" MasterPageFile="~/NV/nvxe/trangchunvxe.Master" AutoEventWireup="true" CodeBehind="Lichphancong.aspx.cs" Inherits="DoAn.NV.nvxe.Lichphancong" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="noidung" runat="server">
    <div id="chuyendi" visible="true" runat="server" style="text-align: center;">
        <asp:Label ID="lb_kdl" runat="server" Text=""></asp:Label>
        <asp:GridView ID="dschuyendi" PageSize="6" runat="server" AllowPaging="true"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Xác Nhận Trạng Thái" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:PlaceHolder ID="CategoryPlaceHolder" runat="server" Visible='<%# Eval("trangthai").ToString().Equals("Sắp đi")%>'>
                            <asp:LinkButton ID="xacnhankh" runat="server" CommandArgument='<%#Eval("Ngaydi")+";"+Eval("giokh") +";"+Eval("machuyenxe") %>' OnClick="xacnhankh_Click">Khởi Hành</asp:LinkButton>
                        </asp:PlaceHolder>
                        <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible='<%# Eval("trangthai").ToString().Equals("Đang đi")%>'>
                            <asp:LinkButton ID="xacnhanht" runat="server" CommandArgument='<%#Eval("machuyenxe")%>' OnClick="xacnhanht_Click">Hoàn Thành</asp:LinkButton>
                        </asp:PlaceHolder>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:TemplateField>
