...
<asp:Content ID="Content3" ContentPlaceHolderID="Chuyendadi" runat="server">
    <link href="../CSS/QLKH.css" rel="stylesheet" />
    <div id="fVe">
        <ul class="menuVe">
            <li><a href="Vecuatoi.aspx">Chuyến sắp đi</a></li>
            <li><a href="Chuyendadi.aspx">Chuyến đã đi</a>
    ...
    <div id="content" style="margin-top: 20px;">
        <asp:GridView runat="server" ID="gr_chuyendadi" AutoGenerateColumns="false" BackColor="White" Width="100%" CellPadding="10">
            <Columns>
