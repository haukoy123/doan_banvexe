...
<asp:Content ID="Content3" ContentPlaceHolderID="Chuyendahuy" runat="server">
    ...
    <div id="fVe">
        ...
        <div runat="server" visible="false" id="thongbao">
            <p style="padding-top: 60px; padding-left: 30px;">Bạn chưa có vé nào, hãy <a href="../Datve/datve.aspx" style="text-decoration: none;">đặt vé tại đây</a></p>
        </div>
    </div>
    <div id="content" style="margin-top: 20px;">
        <asp:GridView runat="server" ID="gr_chuyendahuy" AutoGenerateColumns="false" BackColor="White" Width="100%" CellPadding="10">
            <Columns>
...
<asp:Content ID="Content2" ContentPlaceHolderID="chitietve" runat="server">
